"""Monthly Rotator v11 — Medium Account ($2K-$20K)

Same scoring as v2 with 10 stock positions. Sweet spot between
v10's concentrated 5 stocks and v2's diversified 15.

Scaling ladder:
  v10: $500-$2K   → top 5, downtrend 3  (main_v10_small.py)
  v11: $2K-$20K   → top 10, downtrend 5  (this file)
  v2:  $20K-$100K → top 15, downtrend 5  (main_v2.py)

At $2K:  $200/stock — buys most stocks except LLY, CAT
At $5K:  $500/stock — buys everything
At $10K: $1K/stock  — 1-2 shares each, full coverage

Includes skip-and-log for stocks too expensive at current capital.
Uses original v2 universe (50 stocks, no cheap additions).
...
class MonthlyRotatorV11Medium(QCAlgorithm):
